    ...
    <div id="centreur">
        ...
        <section id="section">
            ...
            <div id="filters">
                ...
                {!! Form::select("filterville", $villes, $filterville, array('placeholder' => "VILLE", 'class' => 'filtres')) !!}
                {!! Form::select("filtertags", $tags, $filtertags, array('placeholder' => "TAGS",'class' => 'filtres')) !!}
                {!! Form::select('filterprix', $prix, $filterprix, array('placeholder' => 'PRIX','class'=> 'filtres')) !!}
                {!! Form::close() !!}
            </div>
            <div id="concerts">
        ...
        <div id="pagination">
            <?php
            $concerts->setpath('search');
            echo $concerts->appends(['filterville' => $filterville, 'filtertags' => $filtertags, 'filterprix' => $filterprix])->render(); ?>
        </div>
    </div>
</body>
</html>